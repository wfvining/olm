...
%% 2025-08-16T14:13:09-06:00

-module(ocpp_message_2_0_1).

-export([update_firmware_response/1,
...
%% @end
-type 'ACChargingParametersType'() :: #{evMinCurrent := integer(),
...
-type 'AuthorizeResponse'() :: #{idTokenInfo := 'IdTokenInfoType'(),
                                 customData => 'CustomDataType'(),
                                 certificateStatus =>
...
-type 'CertificateSignedRequest'() :: #{customData => 'CustomDataType'(),
                                        certificateType =>
...
%% @end
-type 'ChargingLimitType'() :: #{isGridCritical => boolean(),
                                 customData => 'CustomDataType'(),
                                 chargingLimitSource :=
...
%% @end
-type 'ChargingNeedsType'() :: #{requestedEnergyTransfer :=
...
%% charging schedule.
%% @end
-type 'ChargingSchedulePeriodType'() :: #{startPeriod := integer(),
                                          phaseToUse => integer(),
                                          numberPhases => integer(), limit := number(),
                                          customData => 'CustomDataType'()}.
...
%% @end
-type 'ChargingScheduleType'() :: #{startSchedule => calendar:datetime(),
                                    salesTariff => 'SalesTariffType'(),
                                    minChargingRate => number(), id := integer(),
                                    duration => integer(),
                                    customData => 'CustomDataType'(),
...
%% has changed.
%% @end
-type 'ChargingStateEnumType'() :: 'Charging' |
                                   'EVConnected' |
                                   'SuspendedEV' |
                                   'SuspendedEVSE' |
                                   'Idle'.
...
-type 'DCChargingParametersType'() :: #{stateOfCharge => integer(),
                                        fullSoC => integer(), evMaxVoltage := integer(),
                                        evMaxPower => integer(),
                                        evMaxCurrent := integer(),
...
%% @end
-type 'EnergyTransferModeEnumType'() :: 'DC' |
                                        'AC_single_phase' |
                                        'AC_two_phase' |
                                        'AC_three_phase'.
...
-type 'FirmwareStatusNotificationRequest'() :: #{status := 'FirmwareStatusEnumType'(),
                                                 requestId => integer(),
                                                 customData => 'CustomDataType'()}.
...
-type 'Get15118EVCertificateRequest'() :: #{iso15118SchemaVersion := string(),
                                            exiRequest := string(),
                                            customData => 'CustomDataType'(),
...
%% forms of identifiers.
%% @end
-type 'IdTokenType'() :: #{type := 'IdTokenEnumType'(), idToken := string(),
                           customData => 'CustomDataType'(),
...
-type 'LogStatusNotificationRequest'() :: #{status := 'UploadLogStatusEnumType'(),
                                            requestId => integer(),
                                            customData => 'CustomDataType'()}.
...
-type 'NotifyEVChargingNeedsRequest'() :: #{maxScheduleTuples => integer(),
                                            evseId := integer(),
                                            customData => 'CustomDataType'(),
...
-type 'PublishFirmwareStatusNotificationRequest'() :: #{status :=
...
-type 'SignCertificateRequest'() :: #{customData => 'CustomDataType'(), csr := string(),
                                      certificateType =>
                                          'CertificateSigningUseEnumType'()}.
...
-type 'TransactionEventRequest'() :: #{triggerReason := 'TriggerReasonEnumType'(),
                                       ...
                                       idToken => 'IdTokenType'(), evse => 'EVSEType'(),
                                       eventType := 'TransactionEventEnumType'(),
                                       customData => 'CustomDataType'(),
                                       cableMaxCurrent => integer()}.

-type 'TransactionEventResponse'() :: #{updatedPersonalMessage =>
                                            'MessageContentType'(),
                                        totalCost => number(),
...
%% @end
-type 'TriggerReasonEnumType'() :: 'Authorized' |
                                   'CablePluggedIn' |
                                   'ChargingRateChanged' |
...
-define(ACChargingParametersType,
        {#{evMinCurrent => cmap:integer_(#{}), evMaxVoltage => cmap:integer_(#{}),
           evMaxCurrent => cmap:integer_(#{}), energyAmount => cmap:integer_(#{}),
...
-define(ChargingProfileCriterionType,
        {#{stackLevel => cmap:integer_(#{}), customData => fun 'CustomDataType'/1,
...
-define(ChargingProfileType,
        {#{validTo => fun cmap:datetime/1, validFrom => fun cmap:datetime/1,
           ...
           recurrencyKind => fun 'RecurrencyKindEnumType'/1, id => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
           chargingSchedule =>
...
-define(ChargingSchedulePeriodType,
        {#{startPeriod => cmap:integer_(#{}), phaseToUse => cmap:integer_(#{}),
           numberPhases => cmap:integer_(#{}), limit => fun cmap:number/1,
           customData => fun 'CustomDataType'/1},
         [{required, [startPeriod, limit]}, {extra_keys, false}]}).

-define(ChargingScheduleType,
        {#{startSchedule => fun cmap:datetime/1, salesTariff => fun 'SalesTariffType'/1,
           minChargingRate => fun cmap:number/1, id => cmap:integer_(#{}),
...
-define(ClearChargingProfileType,
        {#{stackLevel => cmap:integer_(#{}), evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
           chargingProfilePurpose => fun 'ChargingProfilePurposeEnumType'/1},
         [{required, []}, {extra_keys, false}]}).
...
-define(ClearMonitoringResultType,
        {#{statusInfo => fun 'StatusInfoType'/1,
           status => fun 'ClearMonitoringStatusEnumType'/1, id => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1},
...
-define(CompositeScheduleType,
        {#{scheduleStart => fun cmap:datetime/1, evseId => cmap:integer_(#{}),
           duration => cmap:integer_(#{}), customData => fun 'CustomDataType'/1,
           chargingSchedulePeriod =>
...
-define(DCChargingParametersType,
        {#{stateOfCharge => cmap:integer_(#{max => 100, min => 0}),
           ...
           evMaxVoltage => cmap:integer_(#{}), evMaxPower => cmap:integer_(#{}),
           evMaxCurrent => cmap:integer_(#{}), evEnergyCapacity => cmap:integer_(#{}),
           energyAmount => cmap:integer_(#{}), customData => fun 'CustomDataType'/1,
...
-define(EventDataType,
        {#{variableMonitoringId => cmap:integer_(#{}), variable => fun 'VariableType'/1,
           ...
           eventId => cmap:integer_(#{}), customData => fun 'CustomDataType'/1,
...
-define(MessageInfoType,
        {#{transactionId => cmap:string_(#{max_length => 36}),
           ...
           message => fun 'MessageContentType'/1, id => cmap:integer_(#{}),
...
-define(NetworkConnectionProfileType,
        {#{vpn => fun 'VPNType'/1, securityProfile => cmap:integer_(#{}),
           ...
           messageTimeout => cmap:integer_(#{}), customData => fun 'CustomDataType'/1,
           apn => fun 'APNType'/1},
         [{required,
           [ocppVersion,
            ocppTransport,
...
-define(SalesTariffType,
        {#{salesTariffEntry =>
           ...
           numEPriceLevels => cmap:integer_(#{}), id => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1},
...
-define(SetMonitoringDataType,
        {#{variable => fun 'VariableType'/1, value => fun cmap:number/1,
           ...
           severity => cmap:integer_(#{}), id => cmap:integer_(#{}),
...
-define(VPNType,
        {#{user => cmap:string_(#{max_length => 20}), type => fun 'VPNEnumType'/1,
...
-define(VariableCharacteristicsType,
        {#{valuesList => cmap:string_(#{max_length => 1000}),
           ...
           maxLimit => fun cmap:number/1, dataType => fun 'DataEnumType'/1,
           customData => fun 'CustomDataType'/1},
...
-define(VariableMonitoringType,
        {#{value => fun cmap:number/1, type => fun 'MonitorEnumType'/1,
           transaction => fun cmap:boolean/1, severity => cmap:integer_(#{}),
           id => cmap:integer_(#{}), customData => fun 'CustomDataType'/1},
...
-define(AuthorizeResponse,
        {#{idTokenInfo => fun 'IdTokenInfoType'/1, customData => fun 'CustomDataType'/1,
...
-define(ClearedChargingLimitRequest,
        {#{evseId => cmap:integer_(#{}), customData => fun 'CustomDataType'/1,
           chargingLimitSource => fun 'ChargingLimitSourceEnumType'/1},
         [{required, [chargingLimitSource]}, {extra_keys, false}]}).
...
-define(CustomerInformationRequest,
        {#{requestId => cmap:integer_(#{}), report => fun cmap:boolean/1,
...
-define(GetChargingProfilesRequest,
        {#{requestId => cmap:integer_(#{}), evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
...
-define(GetCompositeScheduleRequest,
        {#{evseId => cmap:integer_(#{}), duration => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
           chargingRateUnit => fun 'ChargingRateUnitEnumType'/1},
...
-define(GetLogRequest,
        {#{retryInterval => cmap:integer_(#{}), retries => cmap:integer_(#{}),
...
-define(NotifyCustomerInformationRequest,
        {#{tbc => fun cmap:boolean/1, seqNo => cmap:integer_(#{}),
           requestId => cmap:integer_(#{}), generatedAt => fun cmap:datetime/1,
...
-define(NotifyEVChargingNeedsRequest,
        {#{maxScheduleTuples => cmap:integer_(#{}), evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
...
-define(NotifyEVChargingScheduleRequest,
        {#{timeBase => fun cmap:datetime/1, evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
...
-define(RequestStartTransactionRequest,
        {#{remoteStartId => cmap:integer_(#{}), idToken => fun 'IdTokenType'/1,
           groupIdToken => fun 'IdTokenType'/1, evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
...
-define(ReserveNowRequest,
        {#{idToken => fun 'IdTokenType'/1, id => cmap:integer_(#{}),
...
-define(ResetRequest,
        {#{type => fun 'ResetEnumType'/1, evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1},
...
-define(StatusNotificationRequest,
        {#{timestamp => fun cmap:datetime/1, evseId => cmap:integer_(#{}),
           customData => fun 'CustomDataType'/1,
...
-define(TransactionEventRequest,
        {#{triggerReason => fun 'TriggerReasonEnumType'/1,
           ...
           seqNo => cmap:integer_(#{}), reservationId => cmap:integer_(#{}),
           offline => fun cmap:boolean/1, numberOfPhasesUsed => cmap:integer_(#{}),
           meterValue =>
               cmap:list_(#{min_length => 1, items => fun 'MeterValueType'/1}),
           idToken => fun 'IdTokenType'/1, evse => fun 'EVSEType'/1,
           eventType => fun 'TransactionEventEnumType'/1,
           customData => fun 'CustomDataType'/1, cableMaxCurrent => cmap:integer_(#{})},
...
-spec 'ChargingLimitSourceEnumType'(string() |
                                    binary() |
                                    atom()) -> 'ChargingLimitSourceEnumType'().
