...
-type 'BatteryDataType'() :: #{
    ...
    soC := number(),
    serialNumber := string(),
    productionDate => datetime:datetime(),
    evseId := integer(),
    customData => 'CustomDataType'()
}.
...
-type 'ChargingProfileType'() :: #{
    ...
    id := integer(),
    dynUpdateTime => datetime:datetime(),
...
-type 'FirmwareType'() :: #{
    ...
    signature => string(),
    retrieveDateTime := datetime:datetime(),
    location := string(),
    installDateTime => datetime:datetime(),
    customData => 'CustomDataType'()
}.
...
-type 'IdTokenInfoType'() :: #{
    ...
    cacheExpiryDateTime => datetime:datetime()
}.
...
-type 'LogParametersType'() :: #{
    ...
    oldestTimestamp => datetime:datetime(),
    latestTimestamp => datetime:datetime(),
    customData => 'CustomDataType'()
}.
...
-type 'NotifySettlementRequest'() :: #{
    ...
    settlementTime := datetime:datetime(),
...
-define(DECODERS, #{
    <<"AFRRSignalRequest">> => afrr_signal_request,
    <<"AFRRSignalResponse">> => afrr_signal_response,
    <<"AdjustPeriodicEventStreamRequest">> =>
        adjust_periodic_event_stream_request,
    <<"AdjustPeriodicEventStreamResponse">> =>
        adjust_periodic_event_stream_response,
    <<"AuthorizeRequest">> => authorize_request,
    <<"AuthorizeResponse">> => authorize_response,
    <<"BatterySwapRequest">> => battery_swap_request,
    <<"BatterySwapResponse">> => battery_swap_response,
    <<"BootNotificationRequest">> =>
    ...
    <<"ChangeTransactionTariffRequest">> =>
        change_transaction_tariff_request,
    <<"ChangeTransactionTariffResponse">> =>
    ...
    <<"ClearTariffsRequest">> => clear_tariffs_request,
    <<"ClearTariffsResponse">> => clear_tariffs_response,
    <<"ClearVariableMonitoringRequest">> =>
    ...
    <<"ClosePeriodicEventStreamRequest">> =>
        close_periodic_event_stream_request,
    <<"ClosePeriodicEventStreamResponse">> =>
        close_periodic_event_stream_response,
    <<"CostUpdatedRequest">> => cost_updated_request,
    <<"CostUpdatedResponse">> => cost_updated_response,
    <<"CustomerInformationRequest">> =>
    ...
    <<"GetBaseReportRequest">> => get_base_report_request,
    <<"GetBaseReportResponse">> => get_base_report_response,
    <<"GetCertificateChainStatusRequest">> =>
        get_certificate_chain_status_request,
    <<"GetCertificateChainStatusResponse">> =>
    ...
    <<"GetDERControlRequest">> => get_der_control_request,
    <<"GetDERControlResponse">> => get_der_control_response,
    <<"GetDisplayMessagesRequest">> =>
    ...
    <<"GetLogRequest">> => get_log_request,
    <<"GetLogResponse">> => get_log_response,
    <<"GetMonitoringReportRequest">> =>
        get_monitoring_report_request,
    <<"GetMonitoringReportResponse">> =>
        get_monitoring_report_response,
    <<"GetPeriodicEventStreamRequest">> =>
        get_periodic_event_stream_request,
    <<"GetPeriodicEventStreamResponse">> =>
        get_periodic_event_stream_response,
    <<"GetReportRequest">> => get_report_request,
    <<"GetReportResponse">> => get_report_response,
    <<"GetTariffsRequest">> => get_tariffs_request,
    <<"GetTariffsResponse">> => get_tariffs_response,
    <<"GetTransactionStatusRequest">> =>
    ...
    <<"NotifyAllowedEnergyTransferRequest">> =>
        notify_allowed_energy_transfer_request,
    <<"NotifyAllowedEnergyTransferResponse">> =>
    ...
    <<"NotifyDERAlarmRequest">> => notify_der_alarm_request,
    <<"NotifyDERAlarmResponse">> =>
        notify_der_alarm_response,
    <<"NotifyDERStartStopRequest">> =>
        notify_der_start_stop_request,
    <<"NotifyDERStartStopResponse">> =>
    ...
    <<"NotifyEventRequest">> => notify_event_request,
    <<"NotifyEventResponse">> => notify_event_response,
    <<"NotifyMonitoringReportRequest">> =>
    ...
    <<"NotifyPriorityChargingRequest">> =>
        notify_priority_charging_request,
    <<"NotifyPriorityChargingResponse">> =>
        notify_priority_charging_response,
    <<"NotifyReportRequest">> => notify_report_request,
    <<"NotifyReportResponse">> => notify_report_response,
    <<"NotifySettlementRequest">> =>
        notify_settlement_request,
    <<"NotifySettlementResponse">> =>
        notify_settlement_response,
    <<"NotifyWebPaymentStartedRequest">> =>
        notify_web_payment_started_request,
    <<"NotifyWebPaymentStartedResponse">> =>
        notify_web_payment_started_response,
    <<"OpenPeriodicEventStreamRequest">> =>
        open_periodic_event_stream_request,
    <<"OpenPeriodicEventStreamResponse">> =>
    ...
    <<"PullDynamicScheduleUpdateRequest">> =>
        pull_dynamic_schedule_update_request,
    <<"PullDynamicScheduleUpdateResponse">> =>
    ...
    <<"ReportDERControlRequest">> =>
        report_der_control_request,
    <<"ReportDERControlResponse">> =>
        report_der_control_response,
    <<"RequestBatterySwapRequest">> =>
        request_battery_swap_request,
    <<"RequestBatterySwapResponse">> =>
    ...
    <<"SetDERControlRequest">> => set_der_control_request,
    <<"SetDERControlResponse">> => set_der_control_response,
    <<"SetDefaultTariffRequest">> =>
        set_default_tariff_request,
    <<"SetDefaultTariffResponse">> =>
    ...
    <<"SetVariablesRequest">> => set_variables_request,
    <<"SetVariablesResponse">> => set_variables_response,
    <<"SignCertificateRequest">> =>
    ...
    <<"UpdateDynamicScheduleRequest">> =>
        update_dynamic_schedule_request,
    <<"UpdateDynamicScheduleResponse">> =>
    ...
    <<"UsePriorityChargingRequest">> =>
        use_priority_charging_request,
    <<"UsePriorityChargingResponse">> =>
        use_priority_charging_response,
    <<"VatNumberValidationRequest">> =>
        vat_number_validation_request,
    <<"VatNumberValidationResponse">> =>
...
-spec clear_der_control_request('ClearDERControlRequest'()) -> message('ClearDERControlRequest'()).
...
-spec clear_der_control_response('ClearDERControlResponse'()) ->
...
-spec get_15118_ev_certificate_request('Get15118EVCertificateRequest'()) ->
...
-spec get_15118_ev_certificate_response('Get15118EVCertificateResponse'()) ->
...
-spec get_der_control_request('GetDERControlRequest'()) -> message('GetDERControlRequest'()).
...
-spec get_der_control_response('GetDERControlResponse'()) -> message('GetDERControlResponse'()).
...
-spec notify_der_alarm_request('NotifyDERAlarmRequest'()) -> message('NotifyDERAlarmRequest'()).
...
-spec notify_der_alarm_response('NotifyDERAlarmResponse'()) -> message('NotifyDERAlarmResponse'()).
...
-spec notify_der_start_stop_request('NotifyDERStartStopRequest'()) ->
...
-spec notify_der_start_stop_response('NotifyDERStartStopResponse'()) ->
...
-spec notify_ev_charging_needs_request('NotifyEVChargingNeedsRequest'()) ->
...
-spec notify_ev_charging_needs_response('NotifyEVChargingNeedsResponse'()) ->
...
-spec notify_ev_charging_schedule_request('NotifyEVChargingScheduleRequest'()) ->
...
-spec notify_ev_charging_schedule_response('NotifyEVChargingScheduleResponse'()) ->
...
-spec report_der_control_request('ReportDERControlRequest'()) ->
...
-spec report_der_control_response('ReportDERControlResponse'()) ->
...
-spec set_der_control_request('SetDERControlRequest'()) -> message('SetDERControlRequest'()).
...
-spec set_der_control_response('SetDERControlResponse'()) -> message('SetDERControlResponse'()).
